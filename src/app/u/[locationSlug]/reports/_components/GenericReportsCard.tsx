    ...
    return (
        <Card className="@container/card relative max-w-[300px]">
            <CardHeader className="relative">
                <CardDescription className="text-xl font-light">{props.title}</CardDescription>
            </CardHeader>
                ...
                {props.isLocked ? (
                    <>
                        ...
                        <div className="bg-background/50 absolute inset-1 flex items-center justify-center backdrop-blur-[1px]">
                            <div className="p-3 text-center">
                                ...
                                <h3 className="mb-1 text-lg font-medium text-amber-700">Not available in your plan</h3>
                    ...
                    <div className="text-4xl tracking-tight">
                        {props.isError ? (
                            <Popover>
                                <PopoverTrigger>
                                    <CloudAlertIcon strokeWidth={2} className="size-12 cursor-pointer stroke-red-500" />
                                </PopoverTrigger>
            ...
            <CardFooter className="flex-col items-start gap-1 text-sm">{props.footer}</CardFooter>
        </Card>
    );
}
