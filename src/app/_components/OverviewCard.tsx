...
export function OverviewCard(props: { title: string; sections: Section[] }) {
  return (
    <div className="mb-4 flex flex-col rounded-xl border-1 border-green-700/20 bg-green-200/10 p-4 text-xs">
