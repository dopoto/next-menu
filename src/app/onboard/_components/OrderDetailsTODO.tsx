...
//     case "open":
//     case "expired":
//       throw new Error(`Stripe - received payment status: ${status}`);
//     default:
//       throw new Error(
//         `Stripe - received unexpected value of Stripe.Checkout.Session.status: ${status}.`,
//       );
//   }
// };
