...
function SignedInCta(props: { tier?: PriceTierId; secondaryText?: string; variant: 'default' | 'outline' }) {
    const { user } = useUser();
...
function SignedOutCta(props: { tier?: PriceTierId; secondaryText?: string; variant: 'default' | 'outline' }) {
    const signUpLink = props.tier ? ROUTES.signUpForPriceTier(props.tier) : ROUTES.signUp;
    return (
        <>
